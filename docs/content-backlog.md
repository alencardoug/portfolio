...
- [ ] **CV em PDF**
  - Preferência: 1–2 páginas.
  - Arquivo sugerido: `public/cv/douglas-alencar-cv.pdf`.
...
## Projeto Engenharia de Dados GCP
...
- [ ] Inserir evidências e screenshots quando fizer sentido.
